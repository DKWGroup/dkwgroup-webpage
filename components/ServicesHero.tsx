    ...
    return (
        <LazyMotion features={domAnimation}>
            <section className="relative bg-[#050505] border-b border-[#333] pt-32 pb-24 overflow-hidden">
                {/* Background photo */}
                <Image
                    src="/portfolio-photos/bc776aa1-9d2d-40ac-aec3-7f366b4f4d8f_rw_600.webp"
                    alt=""
                    fill
                ...
                />
                {/* Dark overlay */}
                <div className="absolute inset-0 z-[1] bg-gradient-to-r from-black via-black/80 to-transparent pointer-events-none"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-bold font-mono text-[var(--color-brand-orange)] uppercase tracking-widest tracking-[0.2em]">Services</span>
                        </m.div>
                        ...
                        <m.p 
                            ...
                            className="text-gray-400 font-mono text-xs md:text-sm leading-relaxed max-w-lg border-l border-[var(--color-brand-orange)] pl-4"
                        >
                            {t("description")}
                        </m.p>
                    </div>
