...
import { Users, Search, Plus, MoreHorizontal, CheckCircle, Clock, FileWarning } from "lucide-react";

// Statyczne dane - MOCK Bazy Danych Klientów
const MOCK_CLIENTS = [
    { id: "C-1001", name: "Jan Kowalski", company: "Investment Partners", email: "jan.k@invest.pl", phone: "+48 500 123 456", status: "Aktywny", date: "15.05.2025" },
    { id: "C-1002", name: "Anna Nowak", company: "Global Logistics SPA", email: "anna@global.com", phone: "+48 600 234 567", status: "W trakcie (Onboarding)", date: "18.05.2025" },
    { id: "C-1003", name: "Piotr Wiśniewski", company: "DevHouse Katowice", email: "piotr@devhouse.pl", phone: "+48 700 345 678", status: "Zakończony", date: "20.04.2025" },
    { id: "C-1004", name: "Kamil L.", company: "Kokpit Kamila", email: "kontakt@kokpit.tv", phone: "+48 800 456 789", status: "Aktywny", date: "01.02.2026" },
    { id: "C-1005", name: "Tomasz B.", company: "Dental Clinic", email: "biuro@dental.pl", phone: "+48 555 666 777", status: "Zagrożony", date: "21.05.2025" },
];
        ...
        <div className="animate-in fade-in duration-500 relative">
            ...
            <div className="bg-[#0a0a0a] border border-[#333] brutal-shadow overflow-hidden">
                            ...
                            {filteredClients.length > 0 ? (
                                filteredClients.map((client, idx) => (
                                    <tr key={idx} className="hover:bg-[#111] transition-colors group">
                                        <td className="px-6 py-4 text-gray-500 font-bold">{client.id}</td>
                                        ...
                                        <td className="px-6 py-4 text-gray-500">{client.date}</td>
                                        <td className="px-6 py-4">
                ...
                <div className="p-4 border-t border-[#333] bg-[#050505] flex justify-between items-center font-mono text-xs text-gray-500">
                    <span>Wyświetlanie {filteredClients.length} z {MOCK_CLIENTS.length} wpisów</span>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in">
                    <div className="bg-[#0a0a0a] border border-[#333] brutal-shadow w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-8">
                            <form className="space-y-6 font-mono text-sm" onSubmit={(e) => { e.preventDefault(); setIsModalOpen(false); }}>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="block text-gray-400 mb-2 uppercase tracking-wider text-xs font-bold">Imię i Nazwisko</label>
                                        <input type="text" className="w-full bg-[#050505] border border-[#333] px-4 py-3 text-white focus:border-[var(--color-brand-orange)] focus:outline-none" required />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="email" className="w-full bg-[#050505] border border-[#333] px-4 py-3 text-white focus:border-[var(--color-brand-orange)] focus:outline-none" required />
                                    </div>
                                    <div>
                                        <label className="block text-gray-400 mb-2 uppercase tracking-wider text-xs font-bold">Numer Telefonu</label>
                                        <input type="tel" className="w-full bg-[#050505] border border-[#333] px-4 py-3 text-white focus:border-[var(--color-brand-orange)] focus:outline-none" />
                                    </div>
                                </div>

                                <div>
                                    <label className="block text-gray-400 mb-2 uppercase tracking-wider text-xs font-bold">Notatki (Brief)</label>
                                    <textarea rows={4} className="w-full bg-[#050505] border border-[#333] px-4 py-3 text-white focus:border-[var(--color-brand-orange)] focus:outline-none resize-none"></textarea>
                                </div>
                                ...
                                <div className="flex justify-end gap-4 pt-4 border-t border-[#333]">
                                    ...
                                    <button type="submit" className="px-6 py-3 bg-[var(--color-brand-orange)] text-black uppercase tracking-widest font-bold font-sans brutal-shadow hover:bg-[#e65c00] transition-colors">Utwórz Konto CRM</button>
                                </div>
                            </form>
                        </div>
                    </div>
